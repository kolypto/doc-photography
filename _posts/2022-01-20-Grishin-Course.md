...
* Рембрандт. По диагонали. Пучок на щеке.
...
Окружение и свет:
* Если рядом есть большие цветные объекты, попросите модель отойти, иначе рефлекс окрасит её в цвет объекта
* Хорошо когда есть белые или серые объекты, например, плитка под ногами
...
* ⭐ Если фон ярче модели, то ищите другой ракурс, чтобы он был темнее. Особенно для контрового света.

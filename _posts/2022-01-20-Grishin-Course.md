...
![](../../../img/grishin/Screenshot_20220203_000920.jpg)
...
![](../../../img/grishin/Screenshot_20220203_003016.jpg)
...
![](../../../img/grishin/Screenshot_20220203_004953.jpg)
...
![](../../../img/grishin/Screenshot_20220207_014953.jpg)
...
![](../../../img/grishin/Screenshot_20220207_022631.jpg)
...
* Хорошая композиция. Сидит прям в центре
* Искренняя эмоция
...
![](../../../img/grishin/Screenshot_20220208_014457.jpg)
...
![](../../../img/grishin/Screenshot_20220208_023531.jpg)
...
![](../../../img/grishin/Screenshot_20220208_024906.jpg)
...
* Человек спереди не привлекает внимание: он размытый, нет деталей, его рубашка по тону подходит к стене, и штаны пропали в тенях
* В кадре есть рамка: дверной проём, который так же делает акцент на нём
* Большинство хороших фотографий сочетают в себе несколько приёмов одновременно

![](../../../img/grishin/Screenshot_20220210_023054.jpg)

* Девушка — самое светлое пятно
* Контраст: светлое на тёмном
* Девушка — объект, на котором объём виден лучше всего: это тоже притягивает внимание. Ведь фон — плоский (нет света и тени), передний план за счёт сильной детализации тоже не даёт объёма (тени если и есть, то мелкие). А на девушке за счёт теней очень хорошо виден объём
* Симметричный снимок: нижняя и верхняя часть в равновесии
* Автор сознательно выбрал светлую одежду. Нужно заранее заботиться о реквизите, образе, и том, как он сочетается с локацией

![](../../../img/grishin/Screenshot_20220210_023449.jpg)

* Контраст. Ярко выраженный
* Самое светлое пятно: платье
* Лицо парня контрастирует с задним фоном
* Направляющая линия в кадре указывает на пару
* Они находятся в центре композиции
* Я как правило не рекомендую размещать объекты в кадре по центру: это очень тривиально, но иногда это очень даже неплохо работает, когда в кадре есть направляющие линии, которые приводят внимание зрителя к композиционному центру

![](../../../img/grishin/Screenshot_20220211_012028.jpg)

* Перед фотосессией мы договорились, что они возьмут белые свитера. Зачем? Потому что в серую погоду на фоне деревьев белый свитер выделит их на фоне стволов деревьев. Иначе они бы потерялись.
* Свитера попросил куипть одинаковые, чтобы они сочетались и имели какой-то общий стиль
* Используется приём "негативное пространство": когда вокруг пары оставляется очень много свободного места. Тёмного.
* Рома обрезан не по колено, а чуть ниже
* Если бы лес был светлый, я попросил бы их надеть тёмное. Но контраст светлого на тёмном всегда работает лучше, чем наоборот.

![](../../../img/grishin/Screenshot_20220211_012601.jpg)

* Контраст: светлое на тёмном
* Контровой свет и тёмный фон. Ещё больше выделяет
* Рамка: синий прямоугольник. Фокусирует внимание на ребят. Глаз обращает внимание на знакомые геометрические формы, поэтому авторы стараются фотографировать людей на фоне геометрических фигур

![](../../../img/grishin/Screenshot_20220211_012920.jpg)

* Объём передаётся с помощью размытия заднего фона: модель отошла от стены. Передний план резкий, задний план размытый. Плановость создаёт контраст.
* Белая одежда выбрана сознательно: я знал, что мы будем фотографироваться в тёмных локациях
* Объём на лице: тоже притягивает внимание
* Рамка: ограничивает пространство для нашего взгляда

![](../../../img/grishin/Screenshot_20220211_013435.jpg)

* Светлое на тёмном
* Я её попросил одеть светлую одежду, а Женя меня поняла буквально, и одела белую :D Смотрится стильно.
* Когда единственный источник света — окно, то контрастная одежда работает лучше всего
* Приём: равновесие. Огонёк сзади и кусок кресла создают цветовые пятна, которые создают равновесие так, что Женя не перевешивает. Если бы там была пустота, то Женя очень сильно перевешивала бы, а левая часть казалась бы пустой и там был бы провал

![](../../../img/grishin/Screenshot_20220211_014038.jpg)

* Контраст тёмное на светлом
* Я просил надеть тёмную одежду и надеть большую шляпу, чтобы мы могли пофотографироваться на поле
* Тень от дерева падает на модель, и изза этого на лице света меньше, чем на заднем плане. Это даёт мягкий свет.
* Если бы она была в светлой одежде, то был бы светлый объект на светлом фоне. Такие приёмы не работают: становится очень плоско
* Если фон тёмный, то модель должна быть светлая. Если фон светлый, то модель должна быть тёмная. Я знал, что мы будем фотографироваться на светлом фоне, и единственный возможный вариант — это тёмная одежда.
* Я спокойно выбрал пересвеченный фон, потому что модель одета в тёмное, и контраст будет прекрасно работать
* Тёмная шляпа нужна для того, чтобы светлое лицо было на тёмном фоне

![](../../../img/grishin/Screenshot_20220211_014539.jpg)

* Заднего плана почти не видно, но плановость чувствуется
* Светлая одежда смотрится очень гармонично на тёмном фоне

---

![](../../../img/grishin/Screenshot_20220211_014611.jpg)

* Пример контраста: есть хорошо заметный тёмный объект, но светлые участки всё равно требуют внимания.
* Так устроено наше зрение, что мы всегда цепляемся взглядом на светлые участки

![](../../../img/grishin/Screenshot_20220211_014651.jpg)

* Обратите внимание, как нам стало комфортнее наблюдать.

---

![](../../../img/grishin/Screenshot_20220211_014718.jpg)

* Хороший свето-теневой рисунок делает его более объёмным
* Но: светлый фон крадёт наше внимание

![](../../../img/grishin/Screenshot_20220211_014754.jpg)

* Мы нашли тёмный фон, и он сразу выглядит более объёмным
...
### Фокусный элемент. Насыщенность

![](../../../img/grishin/Screenshot_20220216_005928.jpg)

* Позволяет выделить цветом какой-либо объект в кадре
* Зданию специально прибавили насыщенности

![](../../../img/grishin/Screenshot_20220216_010141.jpg)

* Кадр сделан очень хитро. Справа — домик, бросается в глаза за счёт геометрической фигуры.
* Домик справа был бы главным на фото, потому что он справа. Человек читает фотографию слева направо, поэтому значимые элементы лучше располагать справа.
* Но автор применил хитрость: тёплое свечение, насыщенность, цвет, приковывает внимание

![](../../../img/grishin/Screenshot_20220216_010331.jpg)

* Красная одежда и красный фургончик специально подобрали, чтобы выделялись. Такой реквизит готовится заранее

![](../../../img/grishin/Screenshot_20220216_010444.jpg)

* Абсолютно серо-синий фон, на котором выделяется девушка

![](../../../img/grishin/Screenshot_20220216_010508.jpg)

* Инверсия: девушка выделяется на ярком фоне
* Ваша задача при работе с моделью — понимать, в какой одежде будет модель, и на какой локации, чтобы создавать контраст
* Не забывайте, что цвета должны гармонировать. Не каждый контраст приятен взгляду.
* Здесь я не согласен: здесь настолько много насыщенно красного, что смотреть на фото неприятно. А синий неудачно с ним контрастирует. Я бы при обработке изменил красный так, чтобы он был более бордовый
...
### Фокусный элемент. Фокус

![](../../../img/grishin/Screenshot_20220216_012226.jpg)

* Вы настраиваете камеру так, чтобы один объект был в фокусе, а остальные объекты пропадали за пределами глубины резкости
* Главный объект — это груша, а всё размытое не имеет значения

![](../../../img/grishin/Screenshot_20220216_012433.jpg)

* Кувшин. Фон размыт

![](../../../img/grishin/Screenshot_20220216_012706.jpg)

* Два приёма: фокус и контраст
* Девушка светлая, выделяется на тёмном фоне
* Она взаимодействует с лошадью. Есть сюжетный акцент: движение рки

![](../../../img/grishin/Screenshot_20220216_012842.jpg)

* Фон размыт. Много людей размыты и не отвлекает

![](../../../img/grishin/Screenshot_20220216_012911.jpg)

* Осень, очень много листвы
* Вся одежда с тех же тонах, что и листва. Снимок смотрится гармонично
* Приём: фокус камеры
* Есть движение: сюжетный центр. Стоп-кадр какого-то действия всегда интересен, его хочется рассмотреть
* Фокусный элемент в правой части фотографии. Фото читается слева направо
* Приём: золотое сечение
* Светлый фон выделяет людей
* Глубина кадра и его объём передаёт диагональ (забор) и воздушная перспектива (светлеющий фон по мере удаления)
...
### Фокусный элемент. Динамика/Статика

![](../../../img/grishin/Screenshot_20220216_013710.jpg)

* Любое движение в кадре создаёт у нас фокус: мы сразу же притягиваем своё внимание, потому что нам интересно. В реальной жизни мы не можем рассмотреть движение в моменте, а фотография позволяет нам это сделать.
* Попросите объект в кадре танцевать, бежать, проявить эмоции
* Приём: контаст тёмное на светлом
* Приём: движение
* Приём: направляющие линии

![](../../../img/grishin/Screenshot_20220216_014151.jpg)

* Вы сразу же увидели человека — потому что это единственный элемент, который не повторяется. Все деревья более-менее одного размера, и вы сразу глазом их прочитали: они стали неинтересны и неактуальны.
* Приём: контраст
* Приём: движение

![](../../../img/grishin/Screenshot_20220216_014311.jpg)

* Движение очень хорошо читается в шаге жениха и в разлетающемуся платью невесты
* Задача кадра была показать локацию, поэтому снято общим планом
* По направлению движения специально оставлено много свободного пространства

![](../../../img/grishin/Screenshot_20220216_014509.jpg)

* При фотографии движения, я стараюсь немного заваливать задний фон, чтобы динамика читалась ещё лучше
* Видно, что пара шагает. Но на самом деле они стоят на месте. Поэтмоу я специлаьно немного завалил линию горизонта, чтобы передать динамику

![](../../../img/grishin/Screenshot_20220216_014632.jpg)

* Линия горизонта завалена для того, чтобы показать, что в кадре есть движение, что изображение не стабильно.
* Шаг и завал горизона придаёт фотографии большую динамику

![](../../../img/grishin/Screenshot_20220216_014717.jpg)

* Сильно завален горизонт. Движение. Эмоции. Это всё делает снимок ярким и динамичным.

![](../../../img/grishin/Screenshot_20220216_014748.jpg)

* А вот здесь завал горизона смотрится крайне плохо: потому что нет динамики. Это уже считается ошибкой.
...
### Фокусный элемент. Лица

![](../../../img/grishin/Screenshot_20220216_014943.jpg)

* Наш мозг так устроен, что мы всегда пытаемся найти знакомые элементы. Особенно лица, или оцертания, которые напоминают лицо.
* Лица будут привлекать внимание в первую очередь
* Здесь внимание сразу падает на крупные лица. И только потом мы замечаем двоих.
* Эмоции реальных людей сильно контрастируют с рисунком, что создаёт диссонанс. В этом задумка.

![](../../../img/grishin/Screenshot_20220216_015135.jpg)

* Огромное количетсво людей. Разглядев эту фотографию — очень легко увидеть главного героя, потому что он единственный смотрит фотографу прямо в объектив.
* Зритель всегда будет контактировать с тем человеком, который контактирует с ним.

![](../../../img/grishin/Screenshot_20220216_015310.jpg)

* Очено много объектов, динамичто, птицы летят, волосы развеваются
* Центром фотографии всё равно будет девушка и её лицо: потому что она действующий персонаж
...
### Фокусный элемент. Направляющие
Вспомогательный приём.

![](../../../img/grishin/Screenshot_20220223_014514.jpg)
![](../../../img/grishin/Screenshot_20220223_014606.jpg)

* Направляющая линия — это вспомогательный фактор, который требует поиска

![](../../../img/grishin/Screenshot_20220223_014616.jpg)
![](../../../img/grishin/Screenshot_20220223_014715.jpg)

* Фотограф встал посередине линий, которые уходят в перспективу, и поставил туда главный объект в кадре
* Обратите внимание, что фонари — это тоже направляющая линия
* Здесь есть ритмы

![](../../../img/grishin/Screenshot_20220223_015356.jpg)
![](../../../img/grishin/Screenshot_20220223_015429.jpg)

* Есть направляющие линии (перила)
* Есть ритмичность (окна которые уходят в перспективу)
* Несущие балки на крыше

![](../../../img/grishin/Screenshot_20220223_015454.jpg)

* Направляющие линии: сходятся за девушкой и приводят внимание к девушке: мост, и бордюр

![](../../../img/grishin/Screenshot_20220223_015532.jpg)

* Фотограф посадил девушку заведомо так, чтобы линии заходили за неё

![](../../../img/grishin/Screenshot_20220223_015605.jpg)

* Контраст
* Огромное количество вспомогательных линий: соединение, а ещё линии зданий
* Снимок очень сбалансирован: ни одна часть не перевешивает

![](../../../img/grishin/Screenshot_20220223_015919.jpg)

* Хочу показать, что направляющие линии не всегда должны быть хорошо читаемые
* Диафрагма открыта так широко, что фон размыт, и не видно, что это за линии
* Мозгу всё равно, что там: линии просто приводят к основному объекту в кадре
* Есть рамка (тёмная арка)

![](../../../img/grishin/Screenshot_20220223_020109.jpg)

* Хочу показать, что линии не всегда должны быть линиями. Люстры приводят к паре. Светильники по сторонам тоже

![](../../../img/grishin/Screenshot_20220223_020207.jpg)

* Хочу показать: линии даже не обязательно должны быть прямыми. Эта линия классно играет с сознанием и плавно приводит к девушке
* Фотограф специально оставил много свободного пространства, и попросил девушку смотреть вверх. Фотограф понимает, что взгляд будет смотреться масштабнее, если она смотрит по направлению к пустому пространству!
* Плавные линии приятны глазу
* Фотография почти чёрно-белая, но с примесью холодного синего цвета. За счёт малого количества цветов снимок воспринимается очень приятно

![](../../../img/grishin/Screenshot_20220223_020451.jpg)

* Множество направляющих линий
* Рамка вокруг человека
* Контраст: тёмное на светлом
* Фигура и движение тоже привлекает внимание
* И передний, и средний, и задний план находятся в зоне резкости. Сильно закрытая диафрагма. Но человек размыт. Значит это монтаж. Значит автор специально вставил в фото идущего человека.

![](../../../img/grishin/Screenshot_20220223_020642.jpg)

* Человек убегает в перспективу, и есть направляющие линии, которые его преследуют
* Есть ритм: столбы на одинаковом расстоянии чередуются между собой. Ритм всегда делает фотографию более динамичной и живой
* Я не согласен с тем, что автор сделал вертикальное фото. Горизонтальное позволило бы сделать так, чтобы столбы не притягивали к себе так много внимания
* Земля на переднем плане придаёт плановости

---

![](../../../img/grishin/Screenshot_20220223_020901.jpg)

* Расскажу вам логику построения композиции на примере данной локации
* Есть теневая сторона и есть солнечная сторона, свет падает сверху
* Если бы я хотел построить композицию с направляющими линиями, то сначала их надо найти
* Направляющие: ступеньки слева внизу
* Направляющие: перила
* Но я не буду их использовать из-за света. Его много. А ещё буду искать красивый фон.
* Поэтому я лучше выберу направляющие под навесом: там есть тень, и столбики, уходящие в перспективу

![](../../../img/grishin/Screenshot_20220223_021158.jpg)

* Свет контровой, задний фон тёмный. Отлично.

![](../../../img/grishin/Screenshot_20220223_021249.jpg)

* На длинном фокусе 85мм фон хороший, тёмный
* Проблемы: свет и композиция. Фото не выдаётся ни тем, ни другим. Нужно поднять экспозицию, и использовать столбики на фото.
* Сейчас ритма на фоне никакого нет: столбики стоят хаотично

![](../../../img/grishin/Screenshot_20220223_021349.jpg)

* Стоит мне поменять ракурс и поставить модель между столбиками, как сразу появляется ритмичность.
* Я выбрал нижнюю точку съёмки, чтобы показать эту перспективу

---

![](../../../img/grishin/Screenshot_20220223_021523.jpg)

* Мы выбрали в качестве локации место под мостом
* Огромное количество машин и отвлекающих элементов
* Главная задача: сосредоточить внимание зрителя на девушке. Иначе все эти окружающие элементы воруют внимание
* Нужно создать акцент с помощью направляющих линий
* Исправим ошибку: те линии, которые сейчас есть в кадре, уводят взгляд от девушки. Мы не обращаем внимания на девушку
* Я хотел ограничить пространство снизу: грязный снег не несёт смысловой нагрузки а только придаёт унылости фотографии
* Я ещё хочу изменить формат фотографии: фото квадратное, а для съёмки модели в полный рост лучше использовать вертикальный формат. Так будет смотреться стройнее.
* Но я хочу показать больше локации, поэтому выбираю горизонтальный формат

![](../../../img/grishin/Screenshot_20220223_021849.jpg)
![](../../../img/grishin/Screenshot_20220223_021938.jpg)

* Много свободного пространства придаёт воздушности снимку
* Мы обрезали ноги
* Модель поставили по центру, чтобы все направляющие линии, которых здесь немало, приводили внимание к модели
* Она приподняла подбородок, чтобы свет падал на лицо и создавал объём
* Есть геометрическая фигура, которая хорошо вписывается в затею: треугольник, сверху, указывающий на девушку. Геометрические фигуры привлекают внимание потому что они хорошо знакомы и мы их узнаём.
...
### Фокусный элемент. Виньетирование и рамки

Виньетирование бывает естественное: объектив при максимально открытой диафрагме даёт затемнение по краям. Чем шире открыта диафрагма, тем сильнее виньетирование.

![](../../../img/grishin/Screenshot_20220622_013100.jpg)

* Виньетирование создаётся объективом фикс при полностью открытой диафрагме

![](../../../img/grishin/Screenshot_20220622_013237.jpg)

* Здесь ещё более характерное виньетирование

![](../../../img/grishin/Screenshot_20220622_013333.jpg)

* Виньетирование ещё бывает искусственное: когда вы создаёте обрамление вокруг объекта, который вы хотите выделить.
* На фото: обрамление, которое выделяет странное, смешное действие.

![](../../../img/grishin/Screenshot_20220622_013429.jpg)

* Обрамление. Рамка имеет скруглённые формы.
* Контровой свет
* Облака, волны, волны на платье: большое количество плавных линий создают приятное ощущение спокойствия

![](../../../img/grishin/Screenshot_20220622_013531.jpg)

* Классический пример рамки вокруг фотографии
* Фотограф сознательно отодвинул модель от фона, чтобы создать больше объёма: плановость
* Лицо не плоское, есть переход от света к тени

![](../../../img/grishin/Screenshot_20220622_013746.jpg)

* Рамка вокруг пары
* Прикольно, что в кадре есть действие, которое совершенно не вяжется с локацией :)
* Светлый объект на тёмном фоне. Есть контраст.

![](../../../img/grishin/Screenshot_20220622_014233.jpg)

* Жених выходит из здания, я спонтанно увидел два столба: рамка
* Если я увидел удачную рамку, я всегда делаю три фото: с верхнего ракурса, со среднего, и с нижнего ракурса. Именно с нижнего ракурса, оказалось, лучше всего смотрятся перила.
* Я попросил его смотреть по направлению света
* Я попросил его совершить какое-нибудь действие: например, застёгивать рубашку

![](../../../img/grishin/Screenshot_20220622_014956.jpg)

* Контровой свет, силуэтная съёмка
* Рамка: фокусный элемент выделен с помощью окна
* Контраст: тёмное на светлом
* Много пространства слева, но там зеркало снова возвращает нас к девушке

![](../../../img/grishin/Screenshot_20220622_015608.jpg)

* Рамка в круглой форме
* Девушка совершает действие: телефон
* Одежда отлично контрастирует с фоном
* Недочёт: единственная не круглая форма — провод от телефона, который рисует угол. Лучше бы он был круглый и смотрелся мягче.

![](../../../img/grishin/Screenshot_20220622_015754.jpg)

* Рамка: серое бетонное здание на фоне
* Контровой свет

![](../../../img/grishin/Screenshot_20220622_015959.jpg)

* Плохо: слишком навязчивая рамка: большое количество пространства, и мы начинаем рассматривать он вместо девушки

![](../../../img/grishin/Screenshot_20220622_020031.jpg)

* Хорошо: стоило девушке отойти от фона, как внимание сразу сосредотачивается на девушке
* Рамка сосредотачивает внимание на верхней части
* Светлое на тёмном создаёт контраст

![](../../../img/grishin/Screenshot_20220622_020207.jpg)

* Плохо: стена сливается с одеждой
* Есть: геометрические фигуры окон можно сделать рамкой, размытие заднего плана, направляющие линии крадут внимание у девушки

![](../../../img/grishin/Screenshot_20220622_020409.jpg)

* Пробуем: уберём из кадра направляющие линии, уводящие внимание от девушки. Уже лучше

![](../../../img/grishin/Screenshot_20220622_020439.jpg)

* Пробуем: уже лучше, равновесие уже вырисовывается

![](../../../img/grishin/Screenshot_20220622_020509.jpg)

* Рамка
* Ритм из вертикальных линий
* Диагональная линия
* Окна уходят в перспективу, показывают пространство

![](../../../img/grishin/Screenshot_20220622_020552.jpg)

* А теперь в кадре нет перспективы, и он выглядит более плоско
* Зато есть рамка
...
### Фокусный элемент. Перспектива и Диагональ

![](../../../img/grishin/Screenshot_20220622_021048.jpg)

* Снимок смотрится объёмным только засчёт плановости: задний фон размыт

![](../../../img/grishin/Screenshot_20220622_021125.jpg)

* Объёмность увеличивается только за счёт диагональных линий, которые уходят за объект кадра. Это расширяет пространство внутри фотографии.
* У домика есть визуальный вес. Второй вес — девушка.
* Снимок выполнен по золотому сечению: и дом, и девушка, находится на третях

---

![](../../../img/grishin/Screenshot_20220622_021307.jpg)

* Линии уходят за модель, есть контраст, есть динамика, но ... эффект объёма слабоват

![](../../../img/grishin/Screenshot_20220622_021333.jpg)

* Стоит нам отойти в сторону, и линии, и пространство, сразу создают объём.

----

![](../../../img/grishin/Screenshot_20220622_021412.jpg)

* Вот пример: я увидел направляющие линии на подоконнике и ритмичность

![](../../../img/grishin/Screenshot_20220622_021529.jpg)

* Я встал так, чтобы была диагональная линия, и чтобы она уходила за пределы кадра

![](../../../img/grishin/Screenshot_20220622_021632.jpg)

* Здесь тоже есть диагональ, которую можно использовать

---

![](../../../img/grishin/Screenshot_20220622_021714.jpg)

* Просто снимаем диагональ сбоку, и создаётся объём

![](../../../img/grishin/Screenshot_20220622_021736.jpg)

* Попробуем использовать этот мост как диагональ

![](../../../img/grishin/Screenshot_20220622_021814.jpg)

* Хорошо, есть объём, но линия режет человека по голове. Это плохо.

![](../../../img/grishin/Screenshot_20220622_021848.jpg)

* Поэтому точка съёмки была выбрана чуть ниже, чтобы сохранить линии, и избавиться от линий которые режут голову

---

![](../../../img/grishin/Screenshot_20220622_021939.jpg)

* Перспектива картинки съедена. Фон не интересный. Поэтому я переместил модель туда, где нашёл направляющие линии

![](../../../img/grishin/Screenshot_20220622_022040.jpg)

* Перила являются направляющей линией, но слишком короткой
* Я также знаю, что чем длиннее фокусное расстояние, тем больше оно съедает перспективу. Я взял широкоугольный объектив.

![](../../../img/grishin/Screenshot_20220622_022157.jpg)

* Хорошо: Перспектива стала более читаемая
* Плохо: правая часть снимка очень перегружена ненужными деталями

![](../../../img/grishin/Screenshot_20220622_022235.jpg)

* Теперь я понимаю, что широкоугольный объектив позволяет мне пустить в кадр больше здания и показать его размер
* Есть ритмичность
* Хорошее освещение
* Контраст
* Не хватает диагонали

![](../../../img/grishin/Screenshot_20220622_022339.jpg)

* Тогда я взял более общий план с нижнего ракурса — и появилась диагональ!
* Плохо: Левая часть очень сильно перегружена

![](../../../img/grishin/Screenshot_20220622_022443.jpg)

* Я переместил модель, чтобы создать равновесие левой и правой части
* Завалил горизонт, чтобы придать динамики
* Дождался порыва ветра, чтобы развевалось пальто
...
### Фокусный элемент. Ритм.

![](../../../img/grishin/Screenshot_20220810_002045.jpg)

* Ритм это повторяющиеся объекты в кадре на одинаковом расстоянии
* Может быть геометрия или события
* Фотография с ритмом смотрится динамично
* Лампы уходят в перспективу и тоже создают ритм
* Идущий человек тоже создаёт динамику

---

![](../../../img/grishin/Screenshot_20220810_002237.jpg)

* Давайте посмотрим на локацию и разберёмся, как использовать ритм.
* Какие объекты повторяются? Столбы
* Нужно создать из повторяющихся объектов диагональ

![](../../../img/grishin/Screenshot_20220810_002457.jpg)

* Я сместился в сторону чтобы появился ритм, который я могу использовать
* Я приоткрыл диафрагму чтобы убрать лишнюю информацию в фоне

---

![](../../../img/grishin/Screenshot_20220810_002713.jpg)

* Задача: найти объекты, которые могут выстраивать ритм
* Это окна. Нужно уйти с горизонтали в диагональ

![](../../../img/grishin/Screenshot_20220810_002807.jpg)

* Теперь видно что повторяющиеся объекты уходят в перспективу

![](../../../img/grishin/Screenshot_20220810_002841.jpg)

* Ритм видно, модель не закрывает его собой.
* Но картинка не сбалансирована и разваливается. Нужно встроить модель в ритм

![](../../../img/grishin/Screenshot_20220810_002933.jpg)

* Выбрав нижний ракурс, сохраняется и фокусный элемент, и ритм
* Диагональ придаёт изображению глубину
...
### Схема. Правило Третей

Схема -- организация объектов на фотографии на основе каких-то рекомендаций.

Наличие любой схемы лучше, чем её полное отсутствие :)

Правило третей: фотография делится на три вертикальные части и три горизонтальные части. Объекти при съёмке лучше всего располагать на пересечении линий: это то место, куда взгляд падает сразу.

![](../../../img/grishin/Screenshot_20220810_003954.jpg)

* Модель в центре кадра. Это является минусом фотографии: зритель сразу же смотрит в центр, и ему сразу же станет скучно, здесь нечего рассматривать слева и справа

![](../../../img/grishin/Screenshot_20220810_004033.jpg)

* Сместили объект на линию трети
* По направлению взгляда теперь больше пространства
* Есть что рассматривать

![](../../../img/grishin/Screenshot_20220810_004107.jpg)

* Лицо на пересечении верхней точки

![](../../../img/grishin/Screenshot_20220810_004123.jpg)

* Если мы поместим модель в левую часть снимка, то есть несколько проблем:
* По направлению взгляда оставлено слишком мало пространства. Ей тесно.
* Наклон травы. Её направление указывает в правую часть снимка. Это направляющая линия, но она указывает туда, где никого нет.

![](../../../img/grishin/Screenshot_20220810_004248.jpg)

* Ход вещей может измениться при работе с крупным потретом
* Работа можешь измениться потому что для зрителя здесь больше информации: брови, нос, губы, глаза, кожа.
* Окружающее пространство уже не так важно, потому что мы хорошо видим портрет и рассматриваем человека
* Когда фон равномерный, уже не так важно, где располагается объект

![](../../../img/grishin/Screenshot_20220810_004435.jpg)

* По направлению взгляда нет пространства, но это уже не важно: мы рассматриваем девушку
* В крупных портретах можно фотографировать модель так, что по направлению взгляда нет пустого пространства

### Схема. Слева направо.

Человек при просмотре фотографии читает снимок слева направо. Поэтому объекты на фотографии рекомендуется располагать именно в правой части снимка.

![](../../../img/grishin/Screenshot_20220810_004738.jpg)

* Основной объект -- пара -- располагается в правой части снимка
* Я хотел показать зрителю сначала пространство, а потом уже пару: чтобы зритель оценил, что они видят, и насколько это захватывающе

![](../../../img/grishin/Screenshot_20220810_005045.jpg)

* Модель тоже неслучайно была расположена в правой части снимка: хотелось подчернуть её
* Взгляд скользит с левой части фотографии, и идёт по линии руки. Я сознательно увёл взгляд зрителя по платью в край фотографии, заставляя его возвращаться к просмотру части снимка с лицом вновь и вновь
* Модель подкидывает платье в этот момент
...
Симметрия — приём, который позволяет создавать идеально сбалансированные снимки.

![](../../../img/grishin/Screenshot_20220810_005355.jpg)

* Левая часть соответствует правой настолько, что снимок кажется зеркально отражённым
* Задача фотографа: разместить центр кадра строго между левой и правой частью моста, и пустить по центру человека
* Это выглядит как картинка, а не как фотография.


![](../../../img/grishin/Screenshot_20220810_005703.jpg)

* Дворец симметрично построен
...
Этим приёмом пользуются, сознательно или несознательно, большинство начинающих фотографов.

Полный кадр: полностью заполнить фотографию вашим главным объектом. Снимаете его максимально крупно.

![](../../../img/grishin/Screenshot_20220810_005908.jpg)

* Квадратный формат
* Вся фотография занята крупнолицевым портретом
* Лоб обрезан, но это не страшно, потому что весь акцент идёт на глаза

![](../../../img/grishin/Screenshot_20220810_010031.jpg)

* Крупнолицевой портрет
* Я бы оставил чуть больше пространства снизу, чтобы показать плечи, а то кажется что у неё бесконечно длинная шея

![](../../../img/grishin/Screenshot_20220810_010103.jpg)

* Весь акцент на глаза мальчика. Очень детализированно. Видна его реакция: он что-то заметил справа.
* Отрезанная голова не создаёт никаких смущений потому что фотограф хотел сосредоточить наше внимание именно во взгляде
...
### Баланс. Визуальный вес.
Баланс -- это равномерное распределение визуальной нагрузки на фотографии.

Фотографию строго можно разделить на две части: левая и правая. Наша задача — создавать баланс таким образом, чтобы ни левая, ни правая часть не перегружали свою сторону, забирая всё внимание на себя. Чтобы не было провалов.

Для этого нужно помнить о приёме "визуальный вес"

![](../../../img/grishin/Screenshot_20220810_010422.jpg)

* Визуальный вес: субъективная характеристика того, насколько сильно объект притягивает взгляд
* Затенённый объект имеет меньший вес, чем объект с яркой рамкой
* Ваша задача: научиться балансировать левую и правую части снимка

![](../../../img/grishin/Screenshot_20220810_010538.jpg)

* Равновесие по горизонтали важнее для восприятия, чем равновесие по вертикали
* Изображение будет казаться сбалансированным только тогда, когда лева и правая части будут одинаково заполненны
* Нам важно, чтобы в левой и в правой частях были объекты, и они находились в равновесии

---

![](../../../img/grishin/Screenshot_20220810_010802.jpg)

* Эта фотография идеально сбалансирована
* Первой внимание привлекает табличка: прямоугольник, контраст чёрного на белом, значки, стрелки. Нам хочется это читать, потому что это всё знакомо
* Правая часть могла бы быть перегружена, но в левой части поместили человека специально, чтобы уравновесить снимок.
* Если бы не было таблички, то левая часть была бы очень перегружена

![](../../../img/grishin/Screenshot_20220810_011124.jpg)

* Баланс соблюдён при помощи цветов
* Справа: девушка в ярком платье контрастирует со стеной
* Слева: полностью жёлтая стена. Большое количество пространства заполнено цветом.

![](../../../img/grishin/Screenshot_20220810_011243.jpg)

* Слева: огромный шар
* Справа: большое количество маленьких шаров

![](../../../img/grishin/Screenshot_20220810_011325.jpg)

* Битва форм: прямоугольник, треугольник, квадрат. Все эти фигуры забирают внимание.
* Много других мелких форм должны забирать внимание зрителя в правую часть фотографии
* Но в итоге весь фокус внимания сводится к паре
* Создаётся ощущение подглядывания через зеркало
* Левая часть с поцелуем уравновешена огромным пятном справа

![](../../../img/grishin/Screenshot_20220810_011511.jpg)

* Слева: приотрыта дверь. Свет. Действие, динамика, всегда интеерсно смотреть. Элемент подглядывания: мы смотрим через дверь.
* Справа: жених контрастирует на фоне окна.
* Жених отражается в зеркале, и нам как бы дают подсмотреть, как жених подсматривает за невестой, немножко инкогнито, как будто из тени

![](../../../img/grishin/Screenshot_20220810_011726.jpg)

* Человек одет не в стиль нашего времени, его хочется рассматривать
* Уравновешена верхняя часть и нижняя часть
* На заднем плане другие стога: создают пространство, воздушность, лёгкость

![](../../../img/grishin/Screenshot_20220810_011904.jpg)

* Слева: пара
* Справа: лопасти целиком
* Есть небольшой ритм: 4 окошка ведут к паре

![](../../../img/grishin/Screenshot_20220810_011957.jpg)

* Сверху: мальчик, большой квадрат, лицо, эмоции
* Снизу: цифра, контраст, маленький квадрат

![](../../../img/grishin/Screenshot_20220810_012113.jpg)

* В фотографии есть рамка, есть контраст, есть человеческая фигура, и всё это в центре. А ещё в центр ведут направляющие линии.
* Так как автор пустил в правую часть три торшера: массивные, тёмные, забирают на себя часть внимания
* В итоге мы рассматриваем фотографию целиком, как совокупность.
* Если бы не было торшеров, то эта часть фотографии нам казалась бы пустой





### Схема. Ключевой момент.

Ключевой момент: привлечение внимания при помощи эмоции или действия. Вы фотографируете события, но уделяете ему не так много пространства, чтобы зрителю нужно было "поискать", что тут происходит.

![](../../../img/grishin/Screenshot_20220810_012443.jpg)

* Очередь, много лиц, много портретов
* Но всё внимание забирает на себя один персонаж. Он ярко выражает свою позицию, в отличие от всех остальных. Он выбивается из общего настроения.
* Обратите внимание, что самый значимый элемент располагается в правой части снимка
* Обратите внимание, что есть равновесие: слева — портртеты, справа — жест

![](../../../img/grishin/Screenshot_20220810_012620.jpg)

* Бракосочетание
* Деталь, которая не сразу бросается в глаза, но вы её воспринимаете. Горизонтальная линия, которая делит снимок на две части: что происходит, и где это происходит.
* Несмотря на большое количетсво людей, весь центр внимания сосредоточен на паре

![](../../../img/grishin/Screenshot_20220810_012938.jpg)

* Первое что мы видим — руки, тянущиеся к небу, а потом уже подброшенного жениха
* Слева и справа — хороший контраст
* По эмоциям понятно, что человек — главный на фотографии

![](../../../img/grishin/Screenshot_20220810_013023.jpg)

* Ключевой момент: девочка, которая удивлена видеть фотографа
* Есть много людей, которые не выражают никаких эмоций
* Девочка занимает мало пространства в кадре, но привлекает всё внимание на себя засчёт эмоции
* В кадре есть направляющая линия
* Чёрно-белый цвет скрывает цветовую композицию, придавая больше значения эмоциям и сюжету
...
### Композиционный приём. Негативное пространство (минимализм)
...
* мм: чем выше фокусное расстояние, тем больше съедается перспектива, становится более плоской.
* мм: широкоугольный объектив лучше передаст пространство, объём, перспективу.
...
* Боковой свет подходит для мужских портретов: придаёт строгости. Женский тоже можно, но надо сгладить тени заполняющим светом
...
* Если модель тёмная, ищите светлый фон.
...
* Разнообразно освещённый фон (светлое/тёмное) создаёт глубину: светлое мы видим ближе, тёмное — дальше
...
Ракурс:
* Если есть удачный фон, сделать фото с трёх ракурсов: верхний, средний, нижний. Чтобы было из чего выбрать.
...
* Можно от него отвернуть модель и использовать его как контровой, а снимать сбоку
* Вопрос: где найти мягкий свет? может, заслонить, отойти, использовать отражение?

Крупный план:
* Я люблю заваливать горизонт при съёмке крупных лицевых портретов: это добавляет динамики, и взгляд получается пронзительнее

Формат:
* Горизонтальный формат показывает пространство
* ⭐ Вертикальный формат подчёркивает фигуру модели в ростовом портрете
* ⭐ Квадратный формат используется в снимках, которые отождествляются со спокойствием
...
Модель:
* Человека в полный рост, особенно девушку, лучше снимать в вертикальном формате. Будет смотреться стройнее.
* Чтобы добавить динамики, можно попросить модель пробежаться. На нас, от нас и взгляд через плечо
* Из головы ничего не должно торчать!
* Должно быть видно кисти рук
* Тёмная локация? Серый день? Мало света? Выбирайте белую одежду.

Девушки:
* Очень важно, чтобы была видна шея! Не закрыта волосами, например
* Кисти! должны быть видны и не обрезаны!

Мужчины:
* Можно использовать половинчатый свет для придания жёсткости.
...
Просмотр:
* Откуда идёт и как падает свет?
* Проверяйте всегда, попали фокусом или нет
* Экспозиция: темно? светло? пересвет? провалы? динамический диапазон как?
* Какая схема освещения получилась на лице?
* Откуда отражается свет? Блики, рефлексы?
* Что попадает в кадр? Добавить, убрать? Баланс есть?
* Есть ли контраст? Светлое на тёмном?
* Цветовая гамма кадра. Если вдруг всё в одной гамме, нужно выкинуть предметы с лишними цветами
* Обрезаны кисти? шея? должны быть видны. Двигай модель
* Торчит одежда? лямки? лишние неопрятные предметы?

Композиция: Фокусный элемент:
* Приёмы:

    1. Высокий контраст
    2. Насыщенность (пост-обработка)
    3. Фокус камеры
    4. Движение
    5. Лица, человеческие фигуры
    6. Фрейминг (рамка или виньетка)

* Белое на тёмном: Одеть белую одежды. Снять на тёмном фоне. Отлично работает в тёмных кафе
* Яркость: При обработке добавить яркости главному элементу
* Насыщенность: Учесть, в какой одежде будет модель, чтобы она контрастировала с фоном: яркостью или цветом.
* Фокус: уведите второстепенные элементы в размытие
* Движение: попросите модель идти, бежать, танцевать, проявить эмоцию. Это интересно и притягивает внимание
* Движение: всегда оставляйте место в кадре по направлению движения. Кстати. взгляд — это тоже движение
* Движение: завалить линию горизонта, чтобы передать динамику
* Лицо: притягивает внимание. Зритель контактирует с тем, кто смотрит в объектив.
* Объём: Снять объёмный объект (с тенями и светлыми пятнами) на однородном сероватом фоне: объёмные объекты больше внимания приковывают
* Центр кадра: слишком тривиально. Но хорошо работает, когда есть направляющие линии, которые приводят внимание к фокусному элементу
* Читается фото: человек читает фото слева направо, потому значимый объект лучше расположить справа
* Вспомогательные элементы:

    1. Направляющие линии
    2. Виньетирование и рамки
    3. Ритм
    4. Геометрия

* Линии: всегда на локации ищите линии, которые могут указывать на модель, особенно если они сводятся на одной точке
* Линии: прекрасно работают перила или тоннели
* Линии: диагональные линии увеличивают объёмность
* Ритм: делает фотографию более динамичной и живой
* Ритм: найти на локации повторяющиеся элементы и попробовать создать из них диагональ
* Геометрия: авторы стараются фотографировать людей на фоне геометрических фигур. Геометрия притягивает внимание.


Композиция: Схема:
* Правило третей: располагать модель в точках пересечения
* Слева направо: человек читает фотографии слева направо. Значит объект стоит разместить справа.
* Симметрия: позволяет создать идеально сбалансированный снимок. Встать по центру, модель по центру.
* Полный кадр. Как вариант, можно снять портрет максимально крупно, даже отрезав лоб. Будет фокус на глаза.

Композиция: Баланс:
* Визуальный вес: насколько сильно объект притягивает взгляд
* Нужно создать баланс визуального веса между левой и правой частями
* Ключевой момент: яркое действие которое притягивает внимание

Обработка:
* Приём: светлое на тёмном
* Приём: тёплое на холодном. Можно добавить синевы к фону.
...
* Контровой свет, если есть! На тёмном фоне!
* Ищи тёмный фон! Светлое на тёмном фоне! Или если модель тёмная, ищи светлый фон!
...
* Варьируй. Крупный-общий, верхний-нижний
* Фокусный элемент. Светлый. На фоне геометрической фигуры. С указывающими линиями. Можно ритмом создать диагональ.
